...
//  the server program.
#define ServerName  "edetocwin8dev.europe.corp.microsoft.com"
#define TargetName  L"mydummyspn/edetocwin8dev.europe.corp.microsoft.com:11000"
...
struct _SecHandle *hcText)
{
	...
	if (NULL == pIn)
	{
		...
		wcscpy_s(lpPackageName, 1024 * sizeof(TCHAR), L"Negotiate");
